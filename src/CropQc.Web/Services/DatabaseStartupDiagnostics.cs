...
public static class DatabaseStartupDiagnostics
{
    ...
    [
        ...
        new("EndOfDayFillReportGroupRooms", "EndOfDayFillReportGroupRooms", null),
        new("EndOfDayFillReportGroupRooms.ReportGroupId", "EndOfDayFillReportGroupRooms", "ReportGroupId", RequireNotNullable: true),
        new("EndOfDayFillReportGroupRooms.RoomId", "EndOfDayFillReportGroupRooms", "RoomId", RequireNotNullable: true),
    ...
    [
        ...
        new("IX_EndOfDayFillReportGroupRooms_ReportGroupId_RoomId", "EndOfDayFillReportGroupRooms", "IX_EndOfDayFillReportGroupRooms_ReportGroupId_RoomId", RequireUnique: true),
    ...
    [
        ...
        new("FK_EndOfDayFillReportGroupRooms_EndOfDayFillReportGroups_ReportGroupId", "EndOfDayFillReportGroupRooms", "FK_EndOfDayFillReportGroupRooms_EndOfDayFillReportGroups_ReportGroupId"),
        new("FK_EndOfDayFillReportGroupRooms_Rooms_RoomId", "EndOfDayFillReportGroupRooms", "FK_EndOfDayFillReportGroupRooms_Rooms_RoomId"),
    ...
    [
        ...
        new("PK_EndOfDayFillReportGroupRooms", "EndOfDayFillReportGroupRooms", "PK_EndOfDayFillReportGroupRooms"),
