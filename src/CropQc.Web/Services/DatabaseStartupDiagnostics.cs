...
{
    public const string ExpectedSchemaMigration = "20260906025535_AddHarvestWatchDeployments";
    ...
    [
        ...
        new("HarvestWatchDeployments", "HarvestWatchDeployments", null),
        new("HarvestWatchDeployments.Id", "HarvestWatchDeployments", "Id", RequireNotNullable: true),
        new("HarvestWatchDeployments.RoomId", "HarvestWatchDeployments", "RoomId", RequireNotNullable: true),
        new("HarvestWatchDeployments.WarehouseId", "HarvestWatchDeployments", "WarehouseId", RequireNotNullable: true),
        new("HarvestWatchDeployments.HarvestWatchCode", "HarvestWatchDeployments", "HarvestWatchCode", RequireNotNullable: true),
        new("HarvestWatchDeployments.Status", "HarvestWatchDeployments", "Status", RequireNotNullable: true),
        new("HarvestWatchDeployments.IsActive", "HarvestWatchDeployments", "IsActive", RequireNotNullable: true),
        new("HarvestWatchDeployments.DeployedAt", "HarvestWatchDeployments", "DeployedAt", RequireNotNullable: true),
        new("HarvestWatchDeployments.DeployedByUserId", "HarvestWatchDeployments", "DeployedByUserId", RequireNotNullable: true),
        new("HarvestWatchDeployments.DeployerEmailSnapshot", "HarvestWatchDeployments", "DeployerEmailSnapshot", RequireNotNullable: true),
        new("HarvestWatchDeployments.WarehouseCodeSnapshot", "HarvestWatchDeployments", "WarehouseCodeSnapshot", RequireNotNullable: true),
        new("HarvestWatchDeployments.RoomCodeSnapshot", "HarvestWatchDeployments", "RoomCodeSnapshot", RequireNotNullable: true),
        new("HarvestWatchDeployments.VarietySnapshot", "HarvestWatchDeployments", "VarietySnapshot", RequireNotNullable: true),
        new("HarvestWatchDeployments.CorrelationToken", "HarvestWatchDeployments", "CorrelationToken", RequireNotNullable: true),
        new("HarvestWatchDeployments.VerificationEmailSentAt", "HarvestWatchDeployments", "VerificationEmailSentAt", RequireNullable: true),
        new("HarvestWatchDeployments.VerificationEmailMessageId", "HarvestWatchDeployments", "VerificationEmailMessageId", RequireNullable: true),
        new("HarvestWatchDeployments.VerificationEmailError", "HarvestWatchDeployments", "VerificationEmailError", RequireNullable: true),
        new("HarvestWatchDeployments.VerifiedAt", "HarvestWatchDeployments", "VerifiedAt", RequireNullable: true),
        new("HarvestWatchDeployments.VerifiedByEmail", "HarvestWatchDeployments", "VerifiedByEmail", RequireNullable: true),
        new("HarvestWatchDeployments.LastReplyMessageId", "HarvestWatchDeployments", "LastReplyMessageId", RequireNullable: true),
        new("HarvestWatchDeployments.ErrorNotificationSentAt", "HarvestWatchDeployments", "ErrorNotificationSentAt", RequireNullable: true),
        new("HarvestWatchDeployments.ErrorNotificationMessageId", "HarvestWatchDeployments", "ErrorNotificationMessageId", RequireNullable: true),
        new("HarvestWatchDeployments.RemovedAt", "HarvestWatchDeployments", "RemovedAt", RequireNullable: true),
        new("HarvestWatchDeployments.RemovedByUserId", "HarvestWatchDeployments", "RemovedByUserId", RequireNullable: true),
        new("HarvestWatchDeployments.CreatedAt", "HarvestWatchDeployments", "CreatedAt", RequireNotNullable: true),
        new("HarvestWatchDeployments.UpdatedAt", "HarvestWatchDeployments", "UpdatedAt", RequireNotNullable: true),
        new("HarvestWatchStatusHistories", "HarvestWatchStatusHistories", null),
        new("HarvestWatchStatusHistories.Id", "HarvestWatchStatusHistories", "Id", RequireNotNullable: true),
        new("HarvestWatchStatusHistories.HarvestWatchDeploymentId", "HarvestWatchStatusHistories", "HarvestWatchDeploymentId", RequireNotNullable: true),
        new("HarvestWatchStatusHistories.PreviousStatus", "HarvestWatchStatusHistories", "PreviousStatus", RequireNullable: true),
        new("HarvestWatchStatusHistories.NewStatus", "HarvestWatchStatusHistories", "NewStatus", RequireNotNullable: true),
        new("HarvestWatchStatusHistories.Source", "HarvestWatchStatusHistories", "Source", RequireNotNullable: true),
        new("HarvestWatchStatusHistories.ChangedAt", "HarvestWatchStatusHistories", "ChangedAt", RequireNotNullable: true),
        new("HarvestWatchStatusHistories.InboundMessageId", "HarvestWatchStatusHistories", "InboundMessageId", RequireNullable: true),
        new("HarvestWatchStatusHistories.ChangedByEmail", "HarvestWatchStatusHistories", "ChangedByEmail", RequireNullable: true),
        new("HarvestWatchStatusHistories.Note", "HarvestWatchStatusHistories", "Note", RequireNullable: true),
        new("HarvestWatchInboundMessages", "HarvestWatchInboundMessages", null),
        new("HarvestWatchInboundMessages.Id", "HarvestWatchInboundMessages", "Id", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.GmailMessageId", "HarvestWatchInboundMessages", "GmailMessageId", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.HarvestWatchDeploymentId", "HarvestWatchInboundMessages", "HarvestWatchDeploymentId", RequireNullable: true),
        new("HarvestWatchInboundMessages.SenderEmail", "HarvestWatchInboundMessages", "SenderEmail", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.Subject", "HarvestWatchInboundMessages", "Subject", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.BodyExcerpt", "HarvestWatchInboundMessages", "BodyExcerpt", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.ReceivedAt", "HarvestWatchInboundMessages", "ReceivedAt", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.Outcome", "HarvestWatchInboundMessages", "Outcome", RequireNotNullable: true),
        new("HarvestWatchInboundMessages.ProcessedAt", "HarvestWatchInboundMessages", "ProcessedAt", RequireNotNullable: true),
        new("HarvestWatchMailboxCursors", "HarvestWatchMailboxCursors", null),
        new("HarvestWatchMailboxCursors.Id", "HarvestWatchMailboxCursors", "Id", RequireNotNullable: true),
        new("HarvestWatchMailboxCursors.LastPolledAt", "HarvestWatchMailboxCursors", "LastPolledAt", RequireNullable: true),
        new("HarvestWatchMailboxCursors.UpdatedAt", "HarvestWatchMailboxCursors", "UpdatedAt", RequireNotNullable: true),
    ...
    [
        ...
        new("IX_HarvestWatchDeployments_CorrelationToken", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_CorrelationToken", RequireUnique: true),
        new("IX_HarvestWatchDeployments_DeployedByUserId", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_DeployedByUserId"),
        new("IX_HarvestWatchDeployments_HarvestWatchCode_IsActive", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_HarvestWatchCode_IsActive", RequireUnique: true),
        new("IX_HarvestWatchDeployments_RemovedByUserId", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_RemovedByUserId"),
        new("IX_HarvestWatchDeployments_RoomId_IsActive", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_RoomId_IsActive"),
        new("IX_HarvestWatchDeployments_WarehouseId", "HarvestWatchDeployments", "IX_HarvestWatchDeployments_WarehouseId"),
        new("IX_HarvestWatchInboundMessages_GmailMessageId", "HarvestWatchInboundMessages", "IX_HarvestWatchInboundMessages_GmailMessageId", RequireUnique: true),
        new("IX_HarvestWatchInboundMessages_HarvestWatchDeploymentId", "HarvestWatchInboundMessages", "IX_HarvestWatchInboundMessages_HarvestWatchDeploymentId"),
        new("IX_HarvestWatchStatusHistories_HarvestWatchDeploymentId_ChangedAt", "HarvestWatchStatusHistories", "IX_HarvestWatchStatusHistories_HarvestWatchDeploymentId_ChangedAt"),
    ...
    [
        ...
        new("FK_HarvestWatchDeployments_Rooms_RoomId", "HarvestWatchDeployments", "FK_HarvestWatchDeployments_Rooms_RoomId"),
        new("FK_HarvestWatchDeployments_Users_DeployedByUserId", "HarvestWatchDeployments", "FK_HarvestWatchDeployments_Users_DeployedByUserId"),
        new("FK_HarvestWatchDeployments_Users_RemovedByUserId", "HarvestWatchDeployments", "FK_HarvestWatchDeployments_Users_RemovedByUserId"),
        new("FK_HarvestWatchDeployments_Warehouses_WarehouseId", "HarvestWatchDeployments", "FK_HarvestWatchDeployments_Warehouses_WarehouseId"),
        new("FK_HarvestWatchInboundMessages_HarvestWatchDeployments_HarvestWatchDeploymentId", "HarvestWatchInboundMessages", "FK_HarvestWatchInboundMessages_HarvestWatchDeployments_HarvestWatchDeploymentId"),
        new("FK_HarvestWatchStatusHistories_HarvestWatchDeployments_HarvestWatchDeploymentId", "HarvestWatchStatusHistories", "FK_HarvestWatchStatusHistories_HarvestWatchDeployments_HarvestWatchDeploymentId"),
    ...
    [
        ...
        new("PK_HarvestWatchDeployments", "HarvestWatchDeployments", "PK_HarvestWatchDeployments"),
        new("PK_HarvestWatchStatusHistories", "HarvestWatchStatusHistories", "PK_HarvestWatchStatusHistories"),
        new("PK_HarvestWatchInboundMessages", "HarvestWatchInboundMessages", "PK_HarvestWatchInboundMessages"),
        new("PK_HarvestWatchMailboxCursors", "HarvestWatchMailboxCursors", "PK_HarvestWatchMailboxCursors"),
    ...
    [
        ...
        ,new("CK_HarvestWatchDeployments_Code", "HarvestWatchDeployments", "CK_HarvestWatchDeployments_Code")
    ];
