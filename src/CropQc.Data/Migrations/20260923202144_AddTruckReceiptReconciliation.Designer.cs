...
namespace CropQc.Data.Migrations
{
    ...
    [Migration("20260923202144_AddTruckReceiptReconciliation")]
    partial class AddTruckReceiptReconciliation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CropQc.Data.Entities.ActualRunDetailCorrection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTimeOffset>("NewRunAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset>("PreviousRunAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.ToTable("ActualRunDetailCorrections");
                });
            ...
            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchDeployment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("DeployerEmailSnapshot")
                        .IsRequired()
                        .HasMaxLength(320)
                        .HasColumnType("nvarchar(320)");

                    b.Property<string>("ErrorNotificationMessageId")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<DateTimeOffset?>("ErrorNotificationSentAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("HarvestWatchCode")
                        .IsRequired()
                        .HasMaxLength(5)
                    ...
                    b.Property<string>("LastReplyMessageId")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("VerificationEmailError")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("VerificationEmailMessageId")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<DateTimeOffset?>("VerificationEmailSentAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("VerifiedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("VerifiedByEmail")
                        .HasMaxLength(320)
                        .HasColumnType("nvarchar(320)");
                    ...
                    b.HasIndex("HarvestWatchCode", "IsActive")
                        .IsUnique()
                        .HasFilter("[IsActive] = 1");

                    b.HasIndex("RoomId", "IsActive");

                    b.ToTable("HarvestWatchDeployments", t =>
                        {
                            t.HasCheckConstraint("CK_HarvestWatchDeployments_Code", "[HarvestWatchCode] NOT LIKE '%[^0-9]%' AND LEN([HarvestWatchCode]) = 5");
                        });
                });

            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchInboundMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("HarvestWatchDeploymentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("HarvestWatchDeploymentId");

                    b.ToTable("HarvestWatchInboundMessages");
                });

            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchMailboxCursor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HarvestWatchMailboxCursors");
                });

            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchStatusHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("HarvestWatchDeploymentId", "ChangedAt");

                    b.ToTable("HarvestWatchStatusHistories");
                });
            ...
            modelBuilder.Entity("CropQc.Data.Entities.InterCrewTransfer", b =>
                {
                    ...
                    b.Property<long?>("ReceivingReceiptId")
                        .HasColumnType("bigint");

                    b.Property<bool>("RequiresTruckReceipt")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ReceivingReceiptId")
                        .IsUnique()
                        .HasFilter("[ReceivingReceiptId] IS NOT NULL");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.InventoryIdentityCorrection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<long?>("CorrectedReceiptId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("ExpectedTreatmentMovementCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TargetFruitProfileId")
                        .HasColumnType("int");

                    b.Property<int>("TargetGrowerLotId")
                        .HasColumnType("int");

                    b.Property<string>("TargetIdentitySnapshotJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("CorrectedReceiptId", "SourceCropYear", "SourceGrowerLotId", "SourceFruitProfileId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CropQc.Data.Entities.OutsideWarehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OutsideWarehouses");
                });

            modelBuilder.Entity("CropQc.Data.Entities.OutsideWarehouseTransfer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("OutsideWarehouseAddressSnapshot")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("OutsideWarehouseCodeSnapshot")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<int>("OutsideWarehouseId")
                        .HasColumnType("int");

                    b.Property<string>("OutsideWarehouseNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("GrowerNumberSnapshot");

                    b.HasIndex("OperationKey")
                        .IsUnique();

                    b.HasIndex("OutsideWarehouseId");
                    ...
                    b.HasIndex("TransferredAt", "OutsideWarehouseId");

                    b.HasIndex("SourceWarehouseId", "SourceRoomId", "TransferredAt");

                    b.ToTable("OutsideWarehouseTransfers");
                });
            ...
            modelBuilder.Entity("CropQc.Data.Entities.PackoutReportSource", b =>
                {
                    ...
                    b.Property<string>("ParseStatus")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasDefaultValue("Legacy metadata only");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.Receipt", b =>
                {
                    ...
                    b.Property<bool>("IsTransferReceipt")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.ReceiptVarietyLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ReceiptId", "FruitProfileId")
                        .IsUnique();

                    b.ToTable("ReceiptVarietyLines");
                });
            ...
            modelBuilder.Entity("CropQc.Data.Entities.RoomInventoryAdjustment", b =>
                {
                    ...
                    b.Property<Guid?>("InventoryIdentityCorrectionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long?>("OutsideWarehouseTransferId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InventoryIdentityCorrectionId");

                    b.HasIndex("InventoryOperationKey")
                        .IsUnique()
                        .HasFilter("[InventoryOperationKey] IS NOT NULL");

                    b.HasIndex("OutsideWarehouseTransferId");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.RoomSealEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchDeployment", b =>
                {
                    b.HasOne("CropQc.Data.Entities.User", "DeployedByUser")
                        .WithMany()
                        .HasForeignKey("DeployedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CropQc.Data.Entities.User", "RemovedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CropQc.Data.Entities.HarvestWatchInboundMessage", b =>
                {
                    b.HasOne("CropQc.Data.Entities.HarvestWatchDeployment", "HarvestWatchDeployment")
                        .WithMany()
                        .HasForeignKey("HarvestWatchDeploymentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("HarvestWatchDeployment");
                });
            ...
            modelBuilder.Entity("CropQc.Data.Entities.InterCrewTransfer", b =>
                {
                    ...
                    b.HasOne("CropQc.Data.Entities.Receipt", "ReceivingReceipt")
                        .WithOne()
                        .HasForeignKey("CropQc.Data.Entities.InterCrewTransfer", "ReceivingReceiptId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CropQc.Data.Entities.InventoryIdentityCorrection", b =>
                {
                    b.HasOne("CropQc.Data.Entities.Receipt", "CorrectedReceipt")
                        .WithMany()
                        .HasForeignKey("CorrectedReceiptId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CropQc.Data.Entities.OutsideWarehouseTransfer", b =>
                {
                    ...
                    b.HasOne("CropQc.Data.Entities.OutsideWarehouse", "OutsideWarehouse")
                        .WithMany("Transfers")
                        .HasForeignKey("OutsideWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CropQc.Data.Entities.Room", b =>
                {
                    ...
                    b.HasOne("CropQc.Data.Entities.User", "SealedByUser")
                        .WithMany()
                        .HasForeignKey("SealedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("CropQc.Data.Entities.RoomInventoryAdjustment", b =>
                {
                    ...
                    b.HasOne("CropQc.Data.Entities.InventoryIdentityCorrection", "InventoryIdentityCorrection")
                        .WithMany("InventoryAdjustments")
                        .HasForeignKey("InventoryIdentityCorrectionId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("InventoryIdentityCorrection");
            ...
            modelBuilder.Entity("CropQc.Data.Entities.ActualRun", b =>
                {
                    b.Navigation("DetailCorrections");
