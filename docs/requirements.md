...
- Master Data includes a Grower Lots / room inventory view so operators can review grower number/name, lot, variety, crop year, facility, room, original bins, current bins, and current/depleted status. Lot identity must consider grower number/name, lot, variety, crop year, and facility rather than assuming lot number alone is unique.
